...
//Variaveis de Objeto
quantPixel = 0;  // Total de Pixeis ja inseridos
corPixel = "red";
temp1 = new Array(1); // matrizes para criar Objeto e guardar temporariamente nome do Pixel
temp2 = new Array(1);
temp3 = new Array(1);
temp4 = new Array(1);
tipoObj = ""; // Guarda tipo do Objeto {I, O, S, Z, T, L }
movimento = 1; // Guarda posicao de giro atual
